...
$ExpectedVersionName = '0.63-relay-raw-read-evidence-no-rf-candidate'
$ExpectedApkSha256 = '29BCCB1FBADDA45C8C307FE2F4F0DCD2DCDDC06E3FB37F866F3C27115B9D6D82'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.63_RelayRawReadEvidenceNoRfCandidate.apk'
...
"@)
        ...
        Write-Host '宿主模式语义门、两单元门和原始读取证据门故障注入自测通过。'
    } finally {
