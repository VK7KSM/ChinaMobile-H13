...
$ExpectedVersionCode = 73
$ExpectedVersionName = '0.73-post-vlc-triple-sos-playout-window-candidate'
$ExpectedApkSha256 = '4FF1D90BE12D6E990AF560061E2DB4E8B9AC00F8DE936A00F5763A15868549D0'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.73_PostVlcTripleSosPlayoutWindowCandidate.apk'
