...
$ExpectedVersionName = '0.71-continuous-body-before-remaining-vlc-no-rf-candidate'
$ExpectedApkSha256 = '94CF7FC6FF1DE27D7B62A1DECB20A11857C8751763ED032CB4402131BB7DEE35'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.71_ContinuousBodyBeforeRemainingVlcNoRfCandidate.apk'
