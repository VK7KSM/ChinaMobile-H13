...
$ExpectedVersionCode = 85
$ExpectedVersionName = '0.85-speech-az09-tail-drain-no-rf'
$ExpectedApkSha256 = 'C8BFBB188C9ADC12AA9090FB5F170AEC881920A1F8BF3D1E46663D13BC3E3DBA'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.85_SpeechAz09TailDrainNoRf.apk'
