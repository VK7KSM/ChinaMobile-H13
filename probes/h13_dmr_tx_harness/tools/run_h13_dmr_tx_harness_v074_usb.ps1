...
$ExpectedVersionCode = 74
$ExpectedVersionName = '0.74-recovery-evidence-priority-candidate'
$ExpectedApkSha256 = '0909AF00EDD3DF1A4457CB461FF00B0CC62C6D79F55A159DF1278640F3F16658'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.74_RecoveryEvidencePriorityCandidate.apk'
