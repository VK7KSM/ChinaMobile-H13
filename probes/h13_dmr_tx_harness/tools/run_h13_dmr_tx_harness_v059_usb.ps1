...
$ExpectedVersionName = '0.59-interleaved-vlc-relay-termination-no-rf-candidate'
$ExpectedApkSha256 = '7DB2A7E7E1FF4C10647680F791540917D63C8880473D9E89C28715C37830EAC4'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.59_InterleavedVlcRelayTerminationNoRfCandidate.apk'
