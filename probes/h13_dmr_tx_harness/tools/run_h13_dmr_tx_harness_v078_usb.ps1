...
$ExpectedVersionCode = 78
$ExpectedVersionName = '0.78-ack-paced-vlc-triple-sos-active-no-rf'
$ExpectedApkSha256 = 'E761C185C8ACDFE985F1BDBB963905C7EFAEB69B44702273391076369A9304BB'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.78_AckPacedVlcTripleSosActiveNoRf.apk'
...
"@)
        ...
        try {
            ...
            $TempActiveTiming = Join-Path ([IO.Path]::GetTempPath()) `
                ('h13-v078-active-timing-' + [guid]::NewGuid().ToString('N'))
