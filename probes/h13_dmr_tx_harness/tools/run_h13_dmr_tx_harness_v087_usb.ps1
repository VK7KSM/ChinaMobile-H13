...
$ExpectedVersionCode = 152
$ExpectedVersionName = '1.52-probes-off'
$ExpectedApkSha256 = '02DCE61341623C27ADFD5A3B2FF46FE8C41B70F84F16304BCDA150D2D0781160'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v1.52_ProbesOff.apk'
