...
$ExpectedVersionCode = 148
$ExpectedVersionName = '1.48-strip-check'
$ExpectedApkSha256 = '53AF638F4FEDA0EBA31E990AFE802B8325EC488A2A86697F667F754A243DA55E'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v1.48_StripCheck.apk'
