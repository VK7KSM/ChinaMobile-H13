...
$ExpectedVersionCode = 147
$ExpectedVersionName = '1.47-service-core'
$ExpectedApkSha256 = 'C1F6E5B36E8723D38100AF5A98AFD732251927860B39F4181BC750AE594EB261'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v1.47_ServiceCore.apk'
