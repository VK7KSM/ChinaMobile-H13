...
$ExpectedVersionCode = 137
$ExpectedVersionName = '1.37-rearm-uplink-diag'
$ExpectedApkSha256 = 'CD96EA560A70BC39EB32758EAE00C2575F8CDB1C10602F2BD8047130B0A89D38'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v1.37_RearmUplinkDiag.apk'
