...
$ExpectedVersionCode = 139
$ExpectedVersionName = '1.39-mcu-lifecycle-clear'
$ExpectedApkSha256 = '91BE1D0B7BFDF06D2A12A0BE1D1C18FD88B598B0A3CA31F69CBFD2A64EFD0373'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v1.39_McuLifecycleClear.apk'
