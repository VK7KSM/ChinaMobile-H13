...
$ExpectedVersionCode = 92
$ExpectedVersionName = '0.92-vocoder-io-before-cmd'
$ExpectedApkSha256 = '5EA1E332C3D2D088AFD1F2BEB4B5CB06284AB9E820C48AE4D4081B0010C74615'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.92_VocoderIoBeforeCmd.apk'
