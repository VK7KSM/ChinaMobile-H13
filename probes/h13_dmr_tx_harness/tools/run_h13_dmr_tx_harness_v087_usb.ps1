...
$ExpectedVersionCode = 143
$ExpectedVersionName = '1.43-powersave-redo'
$ExpectedApkSha256 = '6306A1CCCA045BB84C7466207AA8385506FB464C746A22B25A7704DC0FB888FA'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v1.43_PowersaveRedo.apk'
