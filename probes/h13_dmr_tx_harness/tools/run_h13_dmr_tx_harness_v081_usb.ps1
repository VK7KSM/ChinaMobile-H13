...
$ExpectedVersionCode = 81
$ExpectedVersionName = '0.81-voice-burst-format-no-rf'
$ExpectedApkSha256 = 'F5D73088D9D146087B029F79E509A58B1D70AEC166980EBE7F99015669F2CB07'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.81_VoiceBurstFormatNoRf.apk'
