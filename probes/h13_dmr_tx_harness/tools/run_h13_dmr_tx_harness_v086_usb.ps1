...
$ExpectedVersionCode = 86
$ExpectedVersionName = '0.86-first-bridge-budget-fix-no-rf'
$ExpectedApkSha256 = '7541889C935A0820B49F532A4910323F53198A7B5D8C69A7118E6051208C27E7'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.86_FirstBridgeBudgetFixNoRf.apk'
