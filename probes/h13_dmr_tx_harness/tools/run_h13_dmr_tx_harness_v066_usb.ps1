...
$ExpectedVersionName = '0.66-relay-failure-read-evidence-no-rf-candidate'
$ExpectedApkSha256 = '9FC014A3BA3B114D5BA10A8FAA48F9657A7BB2AFA784CCA89A4D2FA30F55E1E1'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.66_RelayFailureReadEvidenceNoRfCandidate.apk'
