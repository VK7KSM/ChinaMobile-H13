...
$ExpectedVersionName = '0.60-strict-incremental-ack-credit-no-rf-candidate'
$ExpectedApkSha256 = 'F5394AC13FF796BB5D0B1BBA03FACE3671FA02D4FD82FD4138C6D0F79954ACC5'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.60_StrictIncrementalAckCreditNoRfCandidate.apk'
