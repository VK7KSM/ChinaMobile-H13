...
$ExpectedVersionName = '0.62-two-unit-software-trigger-no-rf-candidate'
$ExpectedApkSha256 = '7B4CC1198878CA17A76EE6680CA28709657E7F662312B718666EB1339B757B08'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.62_TwoUnitSoftwareTriggerNoRfCandidate.apk'
...
"@)
        ...
        Write-Host '宿主模式语义门和两单元证据门故障注入自测通过。'
    } finally {
