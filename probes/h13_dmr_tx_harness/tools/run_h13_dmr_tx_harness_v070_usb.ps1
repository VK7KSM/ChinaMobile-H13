...
$ExpectedVersionName = '0.70-single-first-credit-then-all-vlc-no-rf-candidate'
$ExpectedApkSha256 = 'BCA905074DC25C80D21CE1FF149E34C32A7DA74911AADC4C483B75846DB5E049'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.70_SingleFirstCreditThenAllVlcNoRfCandidate.apk'
