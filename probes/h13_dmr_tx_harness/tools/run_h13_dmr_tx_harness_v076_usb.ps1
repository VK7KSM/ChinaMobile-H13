...
$ExpectedVersionCode = 76
$ExpectedVersionName = '0.76-post-vlc-entry-dispatch-fix-no-rf'
$ExpectedApkSha256 = 'EE95417860239974094D186D771821E56FEB9172C5CB022CE23DD92F648F33FB'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.76_PostVlcEntryDispatchFixNoRf.apk'
