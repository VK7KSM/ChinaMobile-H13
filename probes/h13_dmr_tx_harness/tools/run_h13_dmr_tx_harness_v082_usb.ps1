...
$ExpectedVersionCode = 82
$ExpectedVersionName = '0.82-voice-burst-format-gate-fix-no-rf'
$ExpectedApkSha256 = 'EC60BDAC317FFBA82DFF00FA8CF06B2B943EB212EEE8E03EE5DE5B96F91ECFE2'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.82_VoiceBurstFormatGateFixNoRf.apk'
