...
$ExpectedVersionCode = 84
$ExpectedVersionName = '0.84-speech-az09-buffer-fix-no-rf'
$ExpectedApkSha256 = '755F25D9EB3C2FF25A24F7C5CCC18DEA4ACAD0904B1B78D32133BFFF51EC16D1'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.84_SpeechAz09BufferFixNoRf.apk'
