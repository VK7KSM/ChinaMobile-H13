...
$ExpectedVersionName = '0.64-vlc-ack-before-data-resume-no-rf-candidate'
$ExpectedApkSha256 = '0FAC9280ECED7770D4071B5A4219DFCC581C3B795CD4B51EA528D72E4867E075'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.64_VlcAckBeforeDataResumeEvidenceNoRfCandidate.apk'
...
"@)
        ...
        Write-Host '宿主模式语义门、两单元门、原始读取门和VLC ACK暂停门故障注入自测通过。'
    } finally {
