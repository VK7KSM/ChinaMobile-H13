...
$ExpectedVersionName = '0.67-one-live-unit-before-vlc1-no-rf-candidate'
$ExpectedApkSha256 = '6D26BF97234D2DA8267D8D83C28E713277EA0897D984D24B32724214A43AEE45'
$Apk = Join-Path $PSScriptRoot '..\dist\H13_DMR_TX_Harness_v0.67_OneLiveUnitBeforeVlc1NoRfCandidate.apk'
...
"@)
        ...
        Write-Host '宿主模式语义门、一单元门、原始读取门、首包边界门和VLC ACK暂停门故障注入自测通过。'
    } finally {
